/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 46cc8159dbca952c5258c11cd2979e70)
...
interface __BaseEnv_Env {
	...
	DEMO_MODE: "true";
	DEMO_TTL_HOURS: "24";
	TRUSTED_ORIGINS: "http://localhost:5173,http://127.0.0.1:5173,http://localhost:8788" | "http://localhost:8797,http://127.0.0.1:8797" | "https://preview.cloudflarebase.com" | "https://cloudflarebase.com";
	WAE_DATASET: "cloudflarebase_auth_events_local" | "cloudflarebase_auth_events_test" | "cloudflarebase_auth_events_preview" | "cloudflarebase_auth_events";
	AuthAgent: DurableObjectNamespace<import("./src/index").AuthAgent>;
	ProjectRegistry: DurableObjectNamespace<import("./src/index").ProjectRegistry>;
	BETTER_AUTH_SECRET?: "P6YAEopHeROWj8TE/tlIA7HnPNO8CGsF6bw+5G5UVxsVidsO5pJF8by37OWYEBlE" | string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "AuthAgent" | "ProjectRegistry";
	}
	interface LocalEnv {
		LOCAL_ANALYTICS: D1Database;
		AUTH_EVENTS: AnalyticsEngineDataset;
	...
	interface TestEnv {
		LOCAL_ANALYTICS: D1Database;
		AUTH_EVENTS: AnalyticsEngineDataset;
		BETTER_AUTH_SECRET: "P6YAEopHeROWj8TE/tlIA7HnPNO8CGsF6bw+5G5UVxsVidsO5pJF8by37OWYEBlE";
		DISABLE_RATE_LIMIT: "true";
		CHAT_MODEL: "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
		DEMO_MODE: "true";
		DEMO_TTL_HOURS: "24";
	...
	interface PreviewEnv {
		...
		SENTRY_ENV: "preview";
		TRUSTED_ORIGINS: "https://preview.cloudflarebase.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHAT_MODEL" | "DEMO_MODE" | "DEMO_TTL_HOURS" | "TRUSTED_ORIGINS" | "WAE_DATASET" | "BETTER_AUTH_SECRET" | "DISABLE_RATE_LIMIT" | "EMAIL_FROM" | "SENTRY_DSN" | "SENTRY_ENV" | "CF_ACCOUNT_ID" | "CF_ANALYTICS_API_TOKEN">> {}
}
declare module "*.sql" {
	const value: string;
