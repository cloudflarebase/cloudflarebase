/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7a7d2c345bdba721da7d7ae1b7cc7368)
...
interface __BaseEnv_Env {
	...
	AI?: Ai;
	BETTER_AUTH_SECRET?: "cloudflarebase-local-dev-secret-at-least-32-chars-long" | "cloudflarebase-e2e-test-secret-at-least-32-chars-long";
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "AuthAgent";
	}
	interface LocalEnv {
		LOCAL_ANALYTICS: D1Database;
		AUTH_EVENTS: AnalyticsEngineDataset;
		AI: Ai;
		BETTER_AUTH_SECRET: "cloudflarebase-local-dev-secret-at-least-32-chars-long";
		CHAT_MODEL: "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "CHAT_MODEL" | "TRUSTED_ORIGINS" | "WAE_DATASET" | "DISABLE_RATE_LIMIT" | "EMAIL_FROM" | "SENTRY_DSN" | "SENTRY_ENV">> {}
}
declare module "*.sql" {
	const value: string;
