/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 8a919540624d2711d4c306ea96a58bf7)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	ADMIN_SECRET: "local-admin-secret" | "e2e-admin-secret" | string;
	DEMO_MODE?: "true";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_SECRET" | "DEMO_MODE" | "SENTRY_DSN">> {}
}
