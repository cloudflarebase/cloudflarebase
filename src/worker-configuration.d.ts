/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 1f3c06f5463b3a6bf0d07cf56f8b7def)
...
interface __BaseEnv_Env {
	...
	DEMO_MODE?: "true";
	AUTH_AGENT: Fetcher /* auth-agent-local */ | Fetcher /* auth-agent-test */ | Fetcher /* auth-agent */ | Fetcher /* auth-agent-preview */;
	SENTRY_DSN?: "";
	PUBLIC_SENTRY_DSN?: "";
	PUBLIC_SENTRY_ENV?: "production" | "preview";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_SECRET" | "DEMO_MODE" | "SENTRY_DSN" | "PUBLIC_SENTRY_DSN" | "PUBLIC_SENTRY_ENV">> {}
}
