...
- Analytics Engine reads use the SQL API. Dashboard polling and the agent cache are both 5 seconds; signup day buckets use the browser's IANA timezone. Cache entries are timezone-specific.
